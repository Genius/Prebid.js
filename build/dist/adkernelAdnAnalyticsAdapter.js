...
var ANALYTICS_VERSION = '1.0.1';
var DEFAULT_QUEUE_TIMEOUT = 4000;
var DEFAULT_HOST = 'tag.adkernel.com';
var storageObj = Object(__WEBPACK_IMPORTED_MODULE_5__src_storageManager_js__["b" /* getStorageManager */])();
var ADK_HB_EVENTS = {
...
function buildRequestTemplate(pubId) {
  var _getNavigationInfo = getNavigationInfo(),
      loc = _getNavigationInfo.loc,
      ref = _getNavigationInfo.ref;
...
analyticsAdapter.enableAnalytics = function (config) {
  if (!config.options.pubId) {
    __WEBPACK_IMPORTED_MODULE_3__src_utils_js__["logError"]('PubId is not defined. Analytics won\'t work');
    return;
  }
...
analyticsAdapter.ajaxCall = function ajaxCall(data) {
  Object(__WEBPACK_IMPORTED_MODULE_4__src_ajax_js__["a" /* ajax */])("https://".concat(analyticsAdapter.context.host, "/hb-analytics"), function () {}, data);
};
...
function getUmtSource(pageUrl, referrer) {
  ...
  function getCurrentTrafficSource(pageUrl, referrer) {
    ...
    if (referrer) {
      ...
      var parsedUrl = __WEBPACK_IMPORTED_MODULE_3__src_utils_js__["parseUrl"](pageUrl);
  ...
  function getReferrer(referrer) {
    var ref = __WEBPACK_IMPORTED_MODULE_3__src_utils_js__["parseUrl"](referrer);
    return [ref.hostname, ref.pathname];
  }

  function getUTM(pageUrl) {
    var urlParameters = __WEBPACK_IMPORTED_MODULE_3__src_utils_js__["parseUrl"](pageUrl).search;
    ...
    __WEBPACK_IMPORTED_MODULE_3__src_utils_js__["_each"](UTM_TAGS, function (utmTagName) {
