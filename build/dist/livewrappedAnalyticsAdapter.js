...
var URL = 'https://lwadm.com/analytics/10';
var EMPTYURL = '';
var REQUESTSENT = 1;
var RESPONSESENT = 2;
var WINSENT = 4;
...
var livewrappedAnalyticsAdapter = _extends(Object(__WEBPACK_IMPORTED_MODULE_2__src_AnalyticsAdapter_js__["a" /* default */])({
  EMPTYURL: EMPTYURL,
  ...
  track: function track(_ref) {
    var eventType = _ref.eventType,
        args = _ref.args;
    var time = __WEBPACK_IMPORTED_MODULE_0__src_utils_js__["timestamp"]();
    __WEBPACK_IMPORTED_MODULE_0__src_utils_js__["logInfo"]('LIVEWRAPPED_EVENT:', [eventType, args]);

    switch (eventType) {
      case __WEBPACK_IMPORTED_MODULE_3__src_constants_json___default.a.EVENTS.AUCTION_INIT:
        __WEBPACK_IMPORTED_MODULE_0__src_utils_js__["logInfo"]('LIVEWRAPPED_AUCTION_INIT:', args);
      ...
      case __WEBPACK_IMPORTED_MODULE_3__src_constants_json___default.a.EVENTS.BID_REQUESTED:
        __WEBPACK_IMPORTED_MODULE_0__src_utils_js__["logInfo"]('LIVEWRAPPED_BID_REQUESTED:', args);
        ...
        args.bids.forEach(function (bidRequest) {
          ...
          __WEBPACK_IMPORTED_MODULE_0__src_utils_js__["logInfo"](bidRequest);
        });
        __WEBPACK_IMPORTED_MODULE_0__src_utils_js__["logInfo"](livewrappedAnalyticsAdapter.requestEvents);
        break;

      case __WEBPACK_IMPORTED_MODULE_3__src_constants_json___default.a.EVENTS.BID_RESPONSE:
        __WEBPACK_IMPORTED_MODULE_0__src_utils_js__["logInfo"]('LIVEWRAPPED_BID_RESPONSE:', args);
      ...
      case __WEBPACK_IMPORTED_MODULE_3__src_constants_json___default.a.EVENTS.BIDDER_DONE:
        __WEBPACK_IMPORTED_MODULE_0__src_utils_js__["logInfo"]('LIVEWRAPPED_BIDDER_DONE:', args);
      ...
      case __WEBPACK_IMPORTED_MODULE_3__src_constants_json___default.a.EVENTS.BID_WON:
        __WEBPACK_IMPORTED_MODULE_0__src_utils_js__["logInfo"]('LIVEWRAPPED_BID_WON:', args);
      ...
      case __WEBPACK_IMPORTED_MODULE_3__src_constants_json___default.a.EVENTS.BID_TIMEOUT:
        __WEBPACK_IMPORTED_MODULE_0__src_utils_js__["logInfo"]('LIVEWRAPPED_BID_TIMEOUT:', args);
      ...
      case __WEBPACK_IMPORTED_MODULE_3__src_constants_json___default.a.EVENTS.AUCTION_END:
        __WEBPACK_IMPORTED_MODULE_0__src_utils_js__["logInfo"]('LIVEWRAPPED_AUCTION_END:', args);
        setTimeout(function () {
          livewrappedAnalyticsAdapter.sendEvents();
        }, BID_WON_TIMEOUT);
        break;
...
livewrappedAnalyticsAdapter.sendEvents = function () {
  ...
  Object(__WEBPACK_IMPORTED_MODULE_1__src_ajax_js__["a" /* ajax */])(initOptions.endpoint || URL, undefined, JSON.stringify(events), {
    method: 'POST'
  });
};
...
function getbidAdUnits() {
  ...
  Object.keys(cache.auctions).forEach(function (auctionId) {
    var auction = cache.auctions[auctionId];
    Object.keys(auction.bidAdUnits).forEach(function (adUnit) {
      var bidAdUnit = auction.bidAdUnits[adUnit];
...
__WEBPACK_IMPORTED_MODULE_4__src_adapterManager_js__["default"].registerAnalyticsAdapter({
