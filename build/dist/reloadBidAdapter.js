  ...
  buildRequests: function buildRequests(validBidRequests, bidderRequest) {
    ...
    for (var vIdx = 0; vIdx < validBidRequests.length; vIdx++) {
      ...
      vPrxClientTool = new ReloadClientTool({
        ...
        wnd: __WEBPACK_IMPORTED_MODULE_1__src_utils_js__["getWindowTop"](),
        rtop: __WEBPACK_IMPORTED_MODULE_1__src_utils_js__["deepAccess"](bidderRequest, 'refererInfo.reachedTop') || false
      });
