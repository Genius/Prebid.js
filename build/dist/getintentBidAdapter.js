...
function produceSize(sizes) {
  function sizeToStr(s) {
    if (Array.isArray(s) && s.length === 2 && Object(__WEBPACK_IMPORTED_MODULE_1__src_utils_js__["isInteger"])(s[0]) && Object(__WEBPACK_IMPORTED_MODULE_1__src_utils_js__["isInteger"])(s[1])) {
      return s.join('x');
    } else {
