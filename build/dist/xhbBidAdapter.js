...
var spec = {
  ...
  buildRequests: function buildRequests(bidRequests, bidderRequest) {
    ...
    var userObjBid = __WEBPACK_IMPORTED_MODULE_4_core_js_pure_features_array_find_js___default()(bidRequests, hasUserInfo);
    var userObj;

    if (userObjBid) {
      userObj = {};
      Object.keys(userObjBid.params.user).filter(function (param) {
        return __WEBPACK_IMPORTED_MODULE_5_core_js_pure_features_array_includes_js___default()(USER_PARAMS, param);
      }).forEach(function (param) {
        return userObj[param] = userObjBid.params.user[param];
      });
    }

    var memberIdBid = __WEBPACK_IMPORTED_MODULE_4_core_js_pure_features_array_find_js___default()(bidRequests, hasMemberId);
...
function newRenderer(adUnitCode, rtbBid) {
  ...
  renderer.setEventHandlers({
    impression: function impression() {
      return __WEBPACK_IMPORTED_MODULE_1__src_utils_js__["logMessage"]('xhb outstream video impression event');
    },
    loaded: function loaded() {
      return __WEBPACK_IMPORTED_MODULE_1__src_utils_js__["logMessage"]('xhb outstream video loaded event');
    },
    ended: function ended() {
      __WEBPACK_IMPORTED_MODULE_1__src_utils_js__["logMessage"]('xhb outstream renderer video event');
...
function getKeywords(keywords) {
  ...
  __WEBPACK_IMPORTED_MODULE_1__src_utils_js__["_each"](keywords, function (v, k) {
    if (__WEBPACK_IMPORTED_MODULE_1__src_utils_js__["isArray"](v)) {
      var values = [];

      __WEBPACK_IMPORTED_MODULE_1__src_utils_js__["_each"](v, function (val) {
        val = __WEBPACK_IMPORTED_MODULE_1__src_utils_js__["getValueString"]('keywords.' + k, val);
      ...
      v = __WEBPACK_IMPORTED_MODULE_1__src_utils_js__["getValueString"]('keywords.' + k, v);

      if (__WEBPACK_IMPORTED_MODULE_1__src_utils_js__["isStr"](v)) {
        v = [v];
      } else {
        return;
...
function newBid(serverBid, rtbBid, bidderRequest) {
  ...
  if (rtbBid.rtb.video) {
    ...
    if (rtbBid.renderer_url) {
      var rendererOptions = __WEBPACK_IMPORTED_MODULE_1__src_utils_js__["deepAccess"](bidderRequest.bids[0], 'renderer.options');
  ...
  } else if (rtbBid.rtb[__WEBPACK_IMPORTED_MODULE_3__src_mediaTypes_js__["c" /* NATIVE */]]) {
    var nativeAd = rtbBid.rtb[__WEBPACK_IMPORTED_MODULE_3__src_mediaTypes_js__["c" /* NATIVE */]];
    bid[__WEBPACK_IMPORTED_MODULE_3__src_mediaTypes_js__["c" /* NATIVE */]] = {
...
function bidToTag(bid) {
  ...
  if (bid.mediaType === __WEBPACK_IMPORTED_MODULE_3__src_mediaTypes_js__["c" /* NATIVE */] || __WEBPACK_IMPORTED_MODULE_1__src_utils_js__["deepAccess"](bid, "mediaTypes.".concat(__WEBPACK_IMPORTED_MODULE_3__src_mediaTypes_js__["c" /* NATIVE */]))) {
    tag.ad_types.push(__WEBPACK_IMPORTED_MODULE_3__src_mediaTypes_js__["c" /* NATIVE */]);

    if (bid.nativeParams) {
      var nativeRequest = buildNativeRequest(bid.nativeParams);
      tag[__WEBPACK_IMPORTED_MODULE_3__src_mediaTypes_js__["c" /* NATIVE */]] = {
        layouts: [nativeRequest]
      };
    }
  }

  var videoMediaType = __WEBPACK_IMPORTED_MODULE_1__src_utils_js__["deepAccess"](bid, "mediaTypes.".concat(__WEBPACK_IMPORTED_MODULE_3__src_mediaTypes_js__["d" /* VIDEO */]));
  var context = __WEBPACK_IMPORTED_MODULE_1__src_utils_js__["deepAccess"](bid, 'mediaTypes.video.context');

  if (bid.mediaType === __WEBPACK_IMPORTED_MODULE_3__src_mediaTypes_js__["d" /* VIDEO */] || videoMediaType) {
    tag.ad_types.push(__WEBPACK_IMPORTED_MODULE_3__src_mediaTypes_js__["d" /* VIDEO */]);
  } // instream gets vastUrl, outstream gets vastXml


  if (bid.mediaType === __WEBPACK_IMPORTED_MODULE_3__src_mediaTypes_js__["d" /* VIDEO */] || videoMediaType && context !== 'outstream') {
  ...
  if (__WEBPACK_IMPORTED_MODULE_1__src_utils_js__["isEmpty"](bid.mediaType) && __WEBPACK_IMPORTED_MODULE_1__src_utils_js__["isEmpty"](bid.mediaTypes) || bid.mediaType === __WEBPACK_IMPORTED_MODULE_3__src_mediaTypes_js__["b" /* BANNER */] || bid.mediaTypes && bid.mediaTypes[__WEBPACK_IMPORTED_MODULE_3__src_mediaTypes_js__["b" /* BANNER */]]) {
  ...
  Object.keys(params).forEach(function (key) {
    ...
    if (requiredParams && minimumParams) {
      ...
      var remaining = adunitKeys.filter(function (key) {
        return !__WEBPACK_IMPORTED_MODULE_5_core_js_pure_features_array_includes_js___default()(requiredKeys, key);
...
function parseMediaType(rtbBid) {
  ...
  if (adType === __WEBPACK_IMPORTED_MODULE_3__src_mediaTypes_js__["d" /* VIDEO */]) {
    return __WEBPACK_IMPORTED_MODULE_3__src_mediaTypes_js__["d" /* VIDEO */];
  } else if (adType === __WEBPACK_IMPORTED_MODULE_3__src_mediaTypes_js__["c" /* NATIVE */]) {
    return __WEBPACK_IMPORTED_MODULE_3__src_mediaTypes_js__["c" /* NATIVE */];
  } else {
    return __WEBPACK_IMPORTED_MODULE_3__src_mediaTypes_js__["b" /* BANNER */];
  }
}
