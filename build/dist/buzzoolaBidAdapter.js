...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__src_video_js__ = __webpack_require__(36);
...
var spec = {
  ...
  interpretResponse: function interpretResponse(_ref, _ref2) {
    ...
    return response.map(function (bid) {
      ...
      var context = __WEBPACK_IMPORTED_MODULE_0__src_utils_js__["deepAccess"](requestBid, 'mediaTypes.video.context');
      var validBid = __WEBPACK_IMPORTED_MODULE_0__src_utils_js__["deepClone"](bid);

      if (validBid.mediaType === __WEBPACK_IMPORTED_MODULE_2__src_mediaTypes_js__["d" /* VIDEO */] && context === __WEBPACK_IMPORTED_MODULE_4__src_video_js__["b" /* OUTSTREAM */]) {
...
function setOutstreamRenderer(bid) {
  ...
  var unitSettings = __WEBPACK_IMPORTED_MODULE_0__src_utils_js__["deepAccess"](adData, 'placement.unit_settings');
