...
var ENDPOINT_URL = 'https://ssp.theadx.com/request';
...
var spec = {
  ...
  isBidRequestValid: function isBidRequestValid(bid) {
    __WEBPACK_IMPORTED_MODULE_0__src_utils_js__["logInfo"]('theadx.isBidRequestValid', bid);
    var res = false;
  ...
  buildRequests: function buildRequests(validBidRequests, bidderRequest) {
    __WEBPACK_IMPORTED_MODULE_0__src_utils_js__["logInfo"]('theadx.buildRequests', 'validBidRequests', validBidRequests, 'bidderRequest', bidderRequest);
    var results = [];
  ...
  interpretResponse: function interpretResponse(serverResponse, request) {
    __WEBPACK_IMPORTED_MODULE_0__src_utils_js__["logInfo"]('theadx.interpretResponse', 'serverResponse', serverResponse, ' request', request);
    var responses = [];
    ...
    if (serverResponse.body) {
      ...
      if (!(__WEBPACK_IMPORTED_MODULE_0__src_utils_js__["isEmpty"](seatBids) || __WEBPACK_IMPORTED_MODULE_0__src_utils_js__["isEmpty"](seatBids[0].bid))) {
        ...
        if (request.mediaTypes && request.mediaTypes.video) {
          ...
          mediaType = __WEBPACK_IMPORTED_MODULE_1__src_mediaTypes_js__["d" /* VIDEO */];
        ...
        if (mediaType == __WEBPACK_IMPORTED_MODULE_1__src_mediaTypes_js__["d" /* VIDEO */] && videoXml) {
  ...
  getUserSyncs: function getUserSyncs(syncOptions, serverResponses) {
    __WEBPACK_IMPORTED_MODULE_0__src_utils_js__["logInfo"]('theadx.getUserSyncs', 'syncOptions', syncOptions, 'serverResponses', serverResponses);
    var syncs = [];
    ...
    serverResponses.forEach(function (resp) {
      var syncIframeUrls = __WEBPACK_IMPORTED_MODULE_0__src_utils_js__["deepAccess"](resp, 'body.ext.sync.iframe');
      var syncImageUrls = __WEBPACK_IMPORTED_MODULE_0__src_utils_js__["deepAccess"](resp, 'body.ext.sync.image');
...
var extractValidSize = function extractValidSize(bidRequest, bidderRequest) {
  ...
  } else if (!__WEBPACK_IMPORTED_MODULE_0__src_utils_js__["isEmpty"](bidRequest.sizes)) {
    requestedSizes = bidRequest.sizes;
  } // Ensure the size array is normalized


  var conformingSize = __WEBPACK_IMPORTED_MODULE_0__src_utils_js__["parseSizesInput"](requestedSizes);

  if (!__WEBPACK_IMPORTED_MODULE_0__src_utils_js__["isEmpty"](conformingSize) && conformingSize[0] != null) {
...
var generateNativeComponent = function generateNativeComponent(bidRequest, bidderRequest) {
  var assets = __WEBPACK_IMPORTED_MODULE_0__src_utils_js__["_map"](bidRequest.mediaTypes.native, function (bidParams, key) {
