...
var spec = {
  ...
  buildRequests: function buildRequests(validBidRequests, bidderRequest) {
    return validBidRequests.map(function (bid) {
      var payload = {
        ...
        currencyCode: __WEBPACK_IMPORTED_MODULE_2__src_config_js__["b" /* config */].getConfig('currency.adServerCurrency') || 'EUR',
  ...
  interpretResponse: function interpretResponse(serverResponse, bidRequest) {
    ...
    try {
      ...
      __WEBPACK_IMPORTED_MODULE_0__src_utils_js__["logError"]('Error while parsing smilewanted response', error);
    }
