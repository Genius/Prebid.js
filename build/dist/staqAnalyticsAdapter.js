...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__src_refererDetection__ = __webpack_require__(50);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__src_ajax__ = __webpack_require__(5);
...
analyticsAdapter.enableAnalytics = function (config) {
  __WEBPACK_IMPORTED_MODULE_5__src_utils__["logInfo"]('Enabling STAQ Adapter');
  staqAdapterRefWin = Object(__WEBPACK_IMPORTED_MODULE_3__src_refererDetection__["b" /* getRefererInfo */])(window);

  if (!config.options.connId) {
    __WEBPACK_IMPORTED_MODULE_5__src_utils__["logError"]('ConnId is not defined. STAQ Analytics won\'t work');
    return;
  }

  if (!config.options.url) {
    __WEBPACK_IMPORTED_MODULE_5__src_utils__["logError"]('URL is not defined. STAQ Analytics won\'t work');
    return;
  }
...
function sendAll() {
  ...
  if (events.length !== 0) {
    var req = events.map(function (event) {
      return _extends({}, event, analyticsAdapter.context.requestTemplate);
    });
...
analyticsAdapter.ajaxCall = function ajaxCall(data) {
  __WEBPACK_IMPORTED_MODULE_5__src_utils__["logInfo"]('SENDING DATA: ' + data);
  Object(__WEBPACK_IMPORTED_MODULE_6__src_ajax__["a" /* ajax */])("//".concat(analyticsAdapter.context.url, "/prebid/").concat(analyticsAdapter.context.connectionId), function () {}, data, {
...
function getUmtSource(pageUrl, referrer) {
  ...
  function getCurrentTrafficSource(pageUrl, referrer) {
    ...
    if (referrer) {
      ...
      var parsedUrl = Object(__WEBPACK_IMPORTED_MODULE_4__src_url__["c" /* parse */])(pageUrl);
  ...
  function getReferrer(referrer) {
    var ref = Object(__WEBPACK_IMPORTED_MODULE_4__src_url__["c" /* parse */])(referrer);
    return [ref.hostname, ref.pathname];
  }

  function getUTM(pageUrl) {
    var urlParameters = Object(__WEBPACK_IMPORTED_MODULE_4__src_url__["c" /* parse */])(pageUrl).search;
    ...
    __WEBPACK_IMPORTED_MODULE_5__src_utils__["_each"](UTM_TAGS, function (utmTagName) {
