...
var MARS_ANALYTICS_URL = 'https://prebid_stats.mars.media/prebidjs/api/analytics.php';
var events = {};

var marsmediaAnalyticsAdapter = _extends(Object(__WEBPACK_IMPORTED_MODULE_1__src_AnalyticsAdapter_js__["a" /* default */])({
  ...
  track: function track(_ref) {
    ...
    if (eventType === 'auctionEnd') {
      setTimeout(function () {
        Object(__WEBPACK_IMPORTED_MODULE_0__src_ajax_js__["a" /* ajax */])(MARS_ANALYTICS_URL, {
