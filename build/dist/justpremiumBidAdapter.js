...
var spec = {
  ...
  buildRequests: function buildRequests(validBidRequests, bidderRequest) {
    ...
    if (Object(__WEBPACK_IMPORTED_MODULE_1__src_utils_js__["deepAccess"])(validBidRequests[0], 'userId.pubcid')) {
      payload.pubcid = Object(__WEBPACK_IMPORTED_MODULE_1__src_utils_js__["deepAccess"])(validBidRequests[0], 'userId.pubcid');
    } else if (Object(__WEBPACK_IMPORTED_MODULE_1__src_utils_js__["deepAccess"])(validBidRequests[0], 'crumbs.pubcid')) {
      payload.pubcid = Object(__WEBPACK_IMPORTED_MODULE_1__src_utils_js__["deepAccess"])(validBidRequests[0], 'crumbs.pubcid');
    }
