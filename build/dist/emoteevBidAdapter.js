...
function onAdapterCalled(env, bidRequest) {
  return {
    ...
    search: {
      ...
      pubcId: Object(__WEBPACK_IMPORTED_MODULE_2__src_utils_js__["deepAccess"])(bidRequest, 'crumbs.pubcid'),
      bidId: bidRequest.bidId,
      adSpaceId: Object(__WEBPACK_IMPORTED_MODULE_2__src_utils_js__["deepAccess"])(bidRequest, 'params.adSpaceId'),
      cache_buster: Object(__WEBPACK_IMPORTED_MODULE_2__src_utils_js__["getUniqueIdentifierStr"])()
    }
  };
}
/**
...
var validateSizes = function validateSizes(sizes) {
  return Object(__WEBPACK_IMPORTED_MODULE_2__src_utils_js__["isArray"])(sizes) && sizes.length > 0 && sizes.every(function (size) {
    return Object(__WEBPACK_IMPORTED_MODULE_2__src_utils_js__["isArray"])(size) && size.length === 2;
  });
};
/**
 * Pure function.
...
var validateContext = function validateContext(context) {
  return Object(__WEBPACK_IMPORTED_MODULE_2__src_utils_js__["contains"])([IN_CONTENT, FOOTER, OVERLAY, WALLPAPER], context);
};
/**
 * Pure function.
 *
...
var validateExternalId = function validateExternalId(externalId) {
  return externalId === undefined || externalId === null || Object(__WEBPACK_IMPORTED_MODULE_2__src_utils_js__["isInteger"])(externalId) && externalId > 0;
};
/**
 * Pure function.
 *
...
var gdprConsent = function gdprConsent(bidderRequest) {
  return (Object(__WEBPACK_IMPORTED_MODULE_2__src_utils_js__["deepAccess"])(bidderRequest, 'gdprConsent.vendorData.vendorConsents') || {})[VENDOR_ID];
};
/**
 * Pure function.
 *
...
var requestsPayload = function requestsPayload(debug, currency, validBidRequests, bidderRequest) {
  return {
    ...
    gdprApplies: Object(__WEBPACK_IMPORTED_MODULE_2__src_utils_js__["deepAccess"])(bidderRequest, 'gdprConsent.gdprApplies'),
...
var resolveEnv = function resolveEnv(config, parameter) {
  var configEnv = Object(__WEBPACK_IMPORTED_MODULE_2__src_utils_js__["deepAccess"])(config, 'emoteev.env');
  if (Object(__WEBPACK_IMPORTED_MODULE_2__src_utils_js__["contains"])([PRODUCTION, STAGING, DEVELOPMENT], parameter)) return parameter;else if (Object(__WEBPACK_IMPORTED_MODULE_2__src_utils_js__["contains"])([PRODUCTION, STAGING, DEVELOPMENT], configEnv)) return configEnv;else return DEFAULT_ENV;
};
/**
 * Pure function
 * @param {object} config pbjs config value
...
var spec = {
  ...
  onTimeout: function onTimeout(bidRequest) {
    return Object(__WEBPACK_IMPORTED_MODULE_2__src_utils_js__["triggerPixel"])(Object(__WEBPACK_IMPORTED_MODULE_2__src_utils_js__["buildUrl"])(_onTimeout(resolveEnv(__WEBPACK_IMPORTED_MODULE_3__src_config_js__["b" /* config */].getConfig(), Object(__WEBPACK_IMPORTED_MODULE_2__src_utils_js__["getParameterByName"])('emoteevEnv')), bidRequest)));
  },
  getUserSyncs: function getUserSyncs(syncOptions) {
    return _getUserSyncs(resolveEnv(__WEBPACK_IMPORTED_MODULE_3__src_config_js__["b" /* config */].getConfig(), Object(__WEBPACK_IMPORTED_MODULE_2__src_utils_js__["getParameterByName"])('emoteevEnv')), syncOptions);
  }
};
