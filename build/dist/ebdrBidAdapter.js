...
var EbdrAdapter = function EbdrAdapter() {
  ...
  function _requestBids(bidReqs) {
    ...
    var scriptUrl = window.location.protocol + '//' + rtbServerDomain + '/hb?callback=window.pbjs.ebdrResponse' + '&zoneid=' + zoneid + '&br=' + encodeURIComponent(JSON.stringify(ebdrBidReq));
  ...
  pbjs.ebdrResponse = function (ebdrResponseObj) {
    var bid = {};
    var key;
    // valid object?
