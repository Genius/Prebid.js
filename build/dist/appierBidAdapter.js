...
var SUPPORTED_AD_TYPES = [__WEBPACK_IMPORTED_MODULE_1__src_mediaTypes_js__["b" /* BANNER */]]; // we have different servers for different regions / farms
...
var spec = {
  ...
  getApiServer: function getApiServer() {
    ...
    var server = __WEBPACK_IMPORTED_MODULE_2__src_config_js__["b" /* config */].getConfig('appier.server');

    if (!server) {
      var farm = __WEBPACK_IMPORTED_MODULE_2__src_config_js__["b" /* config */].getConfig('appier.farm');
