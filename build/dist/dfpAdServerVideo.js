...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__src_targeting__ = __webpack_require__(33);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__src_hook__ = __webpack_require__(13);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__src_auctionManager__ = __webpack_require__(23);
...
function buildDfpVideoUrl(options) {
  ...
  var bid = options.bid || __WEBPACK_IMPORTED_MODULE_1__src_targeting__["a" /* targeting */].getWinningBids(adUnit.code)[0];
  var urlComponents = {};
...
Object(__WEBPACK_IMPORTED_MODULE_5__src_hook__["a" /* getHook */])('registerAdserver').before(notifyTranslationModule);
/**
...
function buildAdpodVideoUrl() {
  ...
  if (!params || !callback) {
    Object(__WEBPACK_IMPORTED_MODULE_3__src_utils__["logError"])("A params object and a callback is required to use pbjs.adServers.dfp.buildAdpodVideoUrl");
    return;
  }
  ...
  function getSizeForAdUnit(code) {
    var adUnit = __WEBPACK_IMPORTED_MODULE_6__src_auctionManager__["a" /* auctionManager */].getAdUnits().filter(function (adUnit) {
      return adUnit.code === code;
    });
    var sizes = Object(__WEBPACK_IMPORTED_MODULE_3__src_utils__["deepAccess"])(adUnit[0], 'mediaTypes.video.playerSize');
    return Object(__WEBPACK_IMPORTED_MODULE_3__src_utils__["parseSizesInput"])(sizes).join('|');
  }
  ...
  function createMasterTag(err, targeting) {
    ...
    var encodedCustomParams = encodeURIComponent(Object(__WEBPACK_IMPORTED_MODULE_2__src_url__["b" /* formatQS */])(customParams));

    var queryParams = _extends({}, defaultParamConstants, derivedParams, params, {
      cust_params: encodedCustomParams
    });

    var masterTag = Object(__WEBPACK_IMPORTED_MODULE_2__src_url__["a" /* format */])({
      protocol: 'https',
      host: 'securepubads.g.doubleclick.net',
      pathname: '/gampad/ads',
      search: queryParams
...
function getDescriptionUrl(bid, components, prop) {
  if (__WEBPACK_IMPORTED_MODULE_4__src_config__["b" /* config */].getConfig('cache.url')) {
    return;
  }
...
function getCustParams(bid, options) {
  ...
  if (adUnit) {
    var allTargeting = __WEBPACK_IMPORTED_MODULE_1__src_targeting__["a" /* targeting */].getAllTargeting(adUnit.code);
...
Object(__WEBPACK_IMPORTED_MODULE_5__src_hook__["e" /* submodule */])('adpod', adpodUtils);
