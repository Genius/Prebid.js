...
function _handleEids(payload, validBidRequests) {
  ...
  if (bidRequest && bidRequest.userId) {
    ...
    _addExternalUserId(eids, __WEBPACK_IMPORTED_MODULE_0__src_utils__["deepAccess"](bidRequest, "userId.criteortus.".concat(BIDDER_CODE, ".userid")), 'criteortus', 1);
...
var spec = {
  ...
  */
  ...
  buildRequests: function buildRequests(validBidRequests, bidderRequest) {
    ...
    payload.ext.wrapper.wv = "Genius_prebid_2.37.0";
