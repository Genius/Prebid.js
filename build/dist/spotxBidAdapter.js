...
var spec = {
  ...
  buildRequests: function buildRequests(bidRequests, bidderRequest) {
    ...
    var spotxRequests = bidRequests.map(function (bid) {
      ...
      if (__WEBPACK_IMPORTED_MODULE_0__src_utils__["getBidIdParameter"]('hide_skin', bid.params) != '') {
        ext.hide_skin = +!!__WEBPACK_IMPORTED_MODULE_0__src_utils__["getBidIdParameter"]('hide_skin', bid.params);
      }
      ...
      if (__WEBPACK_IMPORTED_MODULE_0__src_utils__["getBidIdParameter"]('spotx_all_google_consent', bid.params) == 1) {
