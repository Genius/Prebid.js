...
var pubperfAdapter = Object(__WEBPACK_IMPORTED_MODULE_0__src_AnalyticsAdapter_js__["a" /* default */])({
  global: 'pubperf_pbjs',
...
pubperfAdapter.enableAnalytics = function (config) {
  if (!config || !config.provider || config.provider !== 'pubperf') {
    __WEBPACK_IMPORTED_MODULE_2__src_utils_js__["logError"]('expected config.provider to equal pubperf');
    return;
  }

  if (!window['pubperf_pbjs']) {
    __WEBPACK_IMPORTED_MODULE_2__src_utils_js__["logError"]("Make sure that Pubperf tag from https://www.pubperf.com is included before the Prebid configuration.");
    return;
  }
...
/* harmony default export */ __webpack_exports__["default"] = (pubperfAdapter);
