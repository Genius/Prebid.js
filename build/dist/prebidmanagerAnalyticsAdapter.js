...
var ajax = Object(__WEBPACK_IMPORTED_MODULE_0__src_ajax_js__["b" /* ajaxBuilder */])(0);
var _VERSION = 1;
...
var prebidmanagerAnalytics = _extends(Object(__WEBPACK_IMPORTED_MODULE_1__src_AnalyticsAdapter_js__["a" /* default */])({
...
function collectUtmTagData() {
  ...
  try {
    utmTags.forEach(function (utmKey) {
      var utmValue = utils.getParameterByName(utmKey);
    ...
    if (newUtm === false) {
      utmTags.forEach(function (utmKey) {
        var itemValue = localStorage.getItem("pm_".concat(utmKey));
      ...
      utmTags.forEach(function (utmKey) {
        localStorage.setItem("pm_".concat(utmKey), pmUtmTags[utmKey]);
      });
    }
  } catch (e) {
    utils.logError("".concat(analyticsName, "Error"), e);
