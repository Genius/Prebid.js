...
var spec = {
  ...
  buildRequests: function buildRequests(validBidRequests, bidderRequest) {
    ...
    */
    ...
    __WEBPACK_IMPORTED_MODULE_0__src_utils_js__["_each"](validBidRequests, function (bid) {
      bid.sizes = __WEBPACK_IMPORTED_MODULE_0__src_utils_js__["isArray"](bid.sizes) && __WEBPACK_IMPORTED_MODULE_0__src_utils_js__["isArray"](bid.sizes[0]) ? bid.sizes : [bid.sizes];
      ...
      imps.push({
        bidId: bid.bidId,
        sizes: bid.sizes,
        adUnitId: __WEBPACK_IMPORTED_MODULE_0__src_utils_js__["getBidIdParameter"]('adUnitId', bid.params)
      });
    }); // Stuff to send: page URL


    var bidReq = {
      reqId: __WEBPACK_IMPORTED_MODULE_0__src_utils_js__["getUniqueIdentifierStr"](),
      imps: imps,
      ref: getReferer(),
      ori: getOrigins()
    };
    var url = 'https://bid.glass/ad/hb.php?' + "src=Genius_prebid_4.2.0";
    return {
      method: 'POST',
      url: url,
  ...
  interpretResponse: function interpretResponse(serverResponse) {
    ...
    __WEBPACK_IMPORTED_MODULE_0__src_utils_js__["_each"](serverResponse.body.bidResponses, function (bid) {
      bidResponses.push({
