      ...
      callback: function callback(_callback) {
        if (errors.length > 0) {
          errors.forEach(function (error) {
            return __WEBPACK_IMPORTED_MODULE_0__src_utils_js__["logError"](error);
          });
        ...
        if (getterResponse) {
          ...
          try {
            ...
            if (error !== '') __WEBPACK_IMPORTED_MODULE_0__src_utils_js__["logError"](error);

            _callback();
          }
        } else {
          Object(__WEBPACK_IMPORTED_MODULE_1__src_ajax_js__["a" /* ajax */])(url, {
            ...
            error: function error(_error) {
              if (_error !== '') __WEBPACK_IMPORTED_MODULE_0__src_utils_js__["logError"](_error);
...
Object(__WEBPACK_IMPORTED_MODULE_2__src_hook_js__["e" /* submodule */])('userId', britepoolIdSubmodule);
