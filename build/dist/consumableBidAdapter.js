...
var spec = {
  ...
  getUserSyncs: function getUserSyncs(syncOptions, serverResponses) {
    ...
    if (syncOptions.pixelEnabled && serverResponses.length > 0) {
      ...
      __WEBPACK_IMPORTED_MODULE_0__src_utils_js__["logWarn"](bidder + ': Please enable iframe based user syncing.');
    }
  }
};
...
function retrieveAd(decision, unitId, unitName) {
  var ad = decision.contents && decision.contents[0] && decision.contents[0].body + __WEBPACK_IMPORTED_MODULE_0__src_utils_js__["createTrackPixelHtml"](decision.impressionUrl);
  return ad;
}
