...
var spec = {
  ...
  buildRequests: function buildRequests(validBidRequests, bidderRequest) {
    ...
    var currency = __WEBPACK_IMPORTED_MODULE_3__src_config_js__["b" /* config */].getConfig('currency.adServerCurrency');
    var cur = currency && [currency];
    var eids = setOnAny(validBidRequests, 'userIdAsEids');
    ...
    if (__WEBPACK_IMPORTED_MODULE_2__src_utils_js__["deepAccess"](bidderRequest, 'gdprConsent.gdprApplies') !== undefined) {
      request.user = {
        ext: {
    ...
    if (bidderRequest.uspConsent) {
      __WEBPACK_IMPORTED_MODULE_2__src_utils_js__["deepSetValue"](request, 'regs.ext.us_privacy', bidderRequest.uspConsent);
    }

    if (eids) {
      __WEBPACK_IMPORTED_MODULE_2__src_utils_js__["deepSetValue"](request, 'user.ext.eids', eids);
    }
