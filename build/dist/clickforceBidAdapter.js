...
var ENDPOINT_URL = 'https://ad.holmesmind.com/adserver/prebid.json?cb=' + new Date().getTime() + '&hb=1&ver=1.21';
var spec = {
  code: BIDDER_CODE,
  ...
  interpretResponse: function interpretResponse(serverResponse, bidRequest) {
    ...
    __WEBPACK_IMPORTED_MODULE_0__src_utils_js__["_each"](serverResponse.body, function (response) {
