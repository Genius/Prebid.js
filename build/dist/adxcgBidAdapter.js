...
var spec = {
  ...
  buildRequests: function buildRequests(validBidRequests, bidderRequest) {
    ...
    var referrer = __WEBPACK_IMPORTED_MODULE_1__src_utils__["deepAccess"](bidderRequest, 'refererInfo.referer');
    var page = __WEBPACK_IMPORTED_MODULE_1__src_utils__["deepAccess"](bidderRequest, 'refererInfo.canonicalUrl') || __WEBPACK_IMPORTED_MODULE_0__src_config__["b" /* config */].getConfig('pageUrl') || __WEBPACK_IMPORTED_MODULE_1__src_utils__["deepAccess"](window, 'location.href');
    ...
    validBidRequests.forEach(function (bid, index) {
      ...
      if (isBannerRequest(bid)) {
        sizes.push(__WEBPACK_IMPORTED_MODULE_1__src_utils__["parseSizesInput"](bid.mediaTypes.banner.sizes).join('|'));
      }
      ...
      if (isVideoRequest(bid)) {
        ...
        sizes.push(__WEBPACK_IMPORTED_MODULE_1__src_utils__["parseSizesInput"](bid.mediaTypes.video.playerSize).join('|'));
    ...
    if (__WEBPACK_IMPORTED_MODULE_1__src_utils__["isStr"](__WEBPACK_IMPORTED_MODULE_1__src_utils__["deepAccess"](validBidRequests, '0.userId.id5id'))) {
      beaconParams.id5id = validBidRequests[0].userId.id5id;
    }

    if (__WEBPACK_IMPORTED_MODULE_1__src_utils__["isStr"](__WEBPACK_IMPORTED_MODULE_1__src_utils__["deepAccess"](validBidRequests, '0.userId.idl_env'))) {
...
function isBannerRequest(bid) {
  return bid.mediaType === 'banner' || !!__WEBPACK_IMPORTED_MODULE_1__src_utils__["deepAccess"](bid, 'mediaTypes.banner');
}

function isNativeRequest(bid) {
  return bid.mediaType === 'native' || !!__WEBPACK_IMPORTED_MODULE_1__src_utils__["deepAccess"](bid, 'mediaTypes.native');
}
