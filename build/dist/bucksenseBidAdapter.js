...
var URL = 'https://prebid.bksn.se:445/prebidjs/';
var spec = {
  code: BIDDER_CODE,
  ...
  */
  isBidRequestValid: function isBidRequestValid(bid) {
    __WEBPACK_IMPORTED_MODULE_2__src_utils__["logInfo"](WHO + ' isBidRequestValid() - INPUT bid:', bid);
  ...
  buildRequests: function buildRequests(validBidRequests, bidderRequest) {
    __WEBPACK_IMPORTED_MODULE_2__src_utils__["logInfo"](WHO + ' buildRequests() - INPUT validBidRequests:', validBidRequests, 'INPUT bidderRequest:', bidderRequest);
    var requests = [];
    ...
    __WEBPACK_IMPORTED_MODULE_2__src_utils__["logInfo"](WHO + ' buildRequests() - requests:', requests);
    return requests;
  },
  ...
  */
  interpretResponse: function interpretResponse(serverResponse, request) {
    __WEBPACK_IMPORTED_MODULE_2__src_utils__["logInfo"](WHO + ' interpretResponse() - INPUT serverResponse:', serverResponse, 'INPUT request:', request);
    var bidResponses = [];
    ...
    if (serverResponse.body) {
      ...
      if (request && sRequestID.length == 0) {
        __WEBPACK_IMPORTED_MODULE_2__src_utils__["logInfo"](WHO + ' interpretResponse() - use RequestID from Placments');
        sRequestID = request.data.bid_id || '';
      }

      if (request && request.data.params.hasOwnProperty('testcpm')) {
        __WEBPACK_IMPORTED_MODULE_2__src_utils__["logInfo"](WHO + ' interpretResponse() - use Test CPM ');
      ...
      __WEBPACK_IMPORTED_MODULE_2__src_utils__["logInfo"](WHO + ' interpretResponse() - serverResponse not valid');
    }

    __WEBPACK_IMPORTED_MODULE_2__src_utils__["logInfo"](WHO + ' interpretResponse() - return', bidResponses);
    return bidResponses;
  }
};
