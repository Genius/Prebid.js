...
var appierAnalyticsAdapter = _extends(Object(__WEBPACK_IMPORTED_MODULE_1__src_AnalyticsAdapter_js__["a" /* default */])({
  ...
  initConfig: function initConfig(config) {
    ...
    if (typeof config.options.affiliateId !== 'string' || config.options.affiliateId.length < 1) {
      Object(__WEBPACK_IMPORTED_MODULE_5__src_utils_js__["logError"])('"options.affiliateId" is required.');
      return false;
    }

    if (typeof config.options.configId !== 'string' || config.options.configId.length < 1) {
      Object(__WEBPACK_IMPORTED_MODULE_5__src_utils_js__["logError"])('"options.configId" is required.');
      return false;
    }
