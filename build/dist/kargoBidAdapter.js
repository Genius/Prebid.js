...
var spec = {
  ...
  buildRequests: function buildRequests(validBidRequests, bidderRequest) {
    var currencyObj = __WEBPACK_IMPORTED_MODULE_1__src_config_js__["b" /* config */].getConfig('currency');
  ...
  _getUserIds: function _getUserIds(tdid, usp) {
  ...
  _getAllMetadata: function _getAllMetadata(tdid, usp) {
    return {
