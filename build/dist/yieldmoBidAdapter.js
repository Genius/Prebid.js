...
var localWindow = __WEBPACK_IMPORTED_MODULE_0__src_utils_js__["getWindowTop"]();
var spec = {
  code: BIDDER_CODE,
  ...
  buildRequests: function buildRequests(bidRequests, bidderRequest) {
    var serverRequest = {
      ...
      userConsent: JSON.stringify({
        ...
        gdprApplies: bidderRequest && bidderRequest.gdprConsent ? bidderRequest.gdprConsent.gdprApplies : '',
        cmp: bidderRequest && bidderRequest.gdprConsent ? bidderRequest.gdprConsent.consentString : ''
      }),
      us_privacy: bidderRequest && bidderRequest.uspConsent ? bidderRequest.uspConsent : ''
    };
    bidRequests.forEach(function (request) {
      ...
      var criteoId = getId(request, 'criteoId');
