...
var spec = {
  ...
  isBidRequestValid: function isBidRequestValid(bid) {
    return !!(bid.params.placement_id && __WEBPACK_IMPORTED_MODULE_0__src_utils_js__["isNumber"](bid.params.placement_id));
  },
  buildRequests: function buildRequests(validBidRequests) {
    ...
    __WEBPACK_IMPORTED_MODULE_0__src_utils_js__["_each"](validBidRequests, function (bid) {
      requests.push({
        ...
        data: JSON.stringify({
          placement_id: __WEBPACK_IMPORTED_MODULE_0__src_utils_js__["getBidIdParameter"]('placement_id', bid.params)
        }),
        bidId: bid.bidId
      });
    });
