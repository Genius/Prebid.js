...
function updateBidStats(auctionId, id, data) {
  var auction = auctionCache[auctionId];
  auction.stats[id].data = _objectSpread({}, auction.stats[id].data, {}, data);
...
var sonobiAdapter = _extends(Object(__WEBPACK_IMPORTED_MODULE_0__src_AnalyticsAdapter__["a" /* default */])({
