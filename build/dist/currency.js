...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__src_bidfactory__ = __webpack_require__(23);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__src_hook_js__ = __webpack_require__(13);
...
__WEBPACK_IMPORTED_MODULE_4__src_config__["b" /* config */].getConfig('currency', function (config) {
...
function initCurrency(url) {
  ...
  Object(__WEBPACK_IMPORTED_MODULE_5__src_hook_js__["a" /* getHook */])('addBidResponse').before(addBidResponseHook, 100); // call for the file if we haven't already
...
function resetCurrency() {
  ...
  Object(__WEBPACK_IMPORTED_MODULE_5__src_hook_js__["a" /* getHook */])('addBidResponse').getHooks({
...
function addBidResponseHook(fn, adUnitCode, bid) {
  ...
  bid.originalCurrency = bid.currency; // execute immediately if the bid is already in the desired currency
