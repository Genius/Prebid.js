...
var ucfunnelAnalyticsAdapter = _extends(Object(__WEBPACK_IMPORTED_MODULE_1__src_AnalyticsAdapter__["a" /* default */])({
  ...
  initConfig: function initConfig(config) {
    ...
    if (typeof config.options.pbuid !== 'string' || config.options.pbuid.length < 1) {
      Object(__WEBPACK_IMPORTED_MODULE_4__src_utils__["logError"])('"options.pbuid" is required.');
      return false;
    }

    if (typeof config.options.adid !== 'string' || config.options.adid.length < 1) {
      Object(__WEBPACK_IMPORTED_MODULE_4__src_utils__["logError"])('"options.adid" is required.');
      return false;
    }
