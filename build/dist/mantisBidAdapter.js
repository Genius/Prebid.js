...
/* harmony export (immutable) */ __webpack_exports__["onVisible"] = onVisible;
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "spec", function() { return spec; });
/* harmony export (immutable) */ __webpack_exports__["sfPostMessage"] = sfPostMessage;
/* harmony export (immutable) */ __webpack_exports__["iframePostMessage"] = iframePostMessage;
...
function onVisible(win, element, doOnVisible, time, pct) {
  var started = null;
  var notified = false;
...
function sfPostMessage($sf, width, height, callback) {
  var viewed = false; // eslint-disable-next-line no-undef
...
;
function iframePostMessage(win, name, callback) {
...
onMessage('iframe', function (data) {
  if (window.$sf) {
    sfPostMessage(window.$sf, data.width, data.height, function () {
      return pixel(data.pixel);
    });
  } else {
    iframePostMessage(window, data.frame, function () {
      return pixel(data.pixel);
    });
  }
});
