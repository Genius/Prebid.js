...
var mediaTypesMap = (_mediaTypesMap = {}, _defineProperty(_mediaTypesMap, __WEBPACK_IMPORTED_MODULE_2__src_mediaTypes__["b" /* BANNER */], 'display'), _defineProperty(_mediaTypesMap, __WEBPACK_IMPORTED_MODULE_2__src_mediaTypes__["d" /* VIDEO */], 'video'), _mediaTypesMap);

function mapMediaType(seedtagMediaType) {
  if (seedtagMediaType === 'display') return __WEBPACK_IMPORTED_MODULE_2__src_mediaTypes__["b" /* BANNER */];
  if (seedtagMediaType === 'video') return __WEBPACK_IMPORTED_MODULE_2__src_mediaTypes__["d" /* VIDEO */];else return seedtagMediaType;
}
...
function hasVideoMandatoryParams(mediaTypes) {
  ...
  var isPlayerSize = !!__WEBPACK_IMPORTED_MODULE_0__src_utils__["deepAccess"](mediaTypes, 'video.playerSize') && __WEBPACK_IMPORTED_MODULE_0__src_utils__["isArray"](__WEBPACK_IMPORTED_MODULE_0__src_utils__["deepAccess"](mediaTypes, 'video.playerSize'));
...
function buildBidRequests(validBidRequests) {
  return __WEBPACK_IMPORTED_MODULE_0__src_utils__["_map"](validBidRequests, function (validBidRequest) {
    ...
    var mediaTypes = __WEBPACK_IMPORTED_MODULE_0__src_utils__["_map"](Object.keys(validBidRequest.mediaTypes), function (pbjsType) {
...
function buildBid(seedtagBid) {
  ...
  if (mediaType === __WEBPACK_IMPORTED_MODULE_2__src_mediaTypes__["d" /* VIDEO */]) {
...
function getTimeoutUrl(data) {
  ...
  if (__WEBPACK_IMPORTED_MODULE_0__src_utils__["isArray"](data) && data[0] && __WEBPACK_IMPORTED_MODULE_0__src_utils__["isArray"](data[0].params) && data[0].params[0]) {
...
var spec = {
  ...
  isBidRequestValid: function isBidRequestValid(bid) {
    return getMediaTypeFromBid(bid) === __WEBPACK_IMPORTED_MODULE_2__src_mediaTypes__["d" /* VIDEO */] ? hasMandatoryParams(bid.params) && hasVideoMandatoryParams(bid.mediaTypes) : hasMandatoryParams(bid.params);
  },
  ...
  interpretResponse: function interpretResponse(serverResponse) {
    ...
    if (serverBody && serverBody.bids && __WEBPACK_IMPORTED_MODULE_0__src_utils__["isArray"](serverBody.bids)) {
      return __WEBPACK_IMPORTED_MODULE_0__src_utils__["_map"](serverBody.bids, function (bid) {
        return buildBid(bid);
      });
    } else {
      return [];
  ...
  onTimeout: function onTimeout(data) {
    getTimeoutUrl(data);
    __WEBPACK_IMPORTED_MODULE_0__src_utils__["triggerPixel"](SEEDTAG_SSP_ONTIMEOUT_ENDPOINT);
  }
};
