...
var spec = {
  ...
  isBidRequestValid: function isBidRequestValid(bid) {
    var rawSizes = __WEBPACK_IMPORTED_MODULE_0__src_utils_js__["deepAccess"](bid, 'mediaTypes.video.playerSize') || bid.sizes;

    if (__WEBPACK_IMPORTED_MODULE_0__src_utils_js__["isEmpty"](rawSizes) || __WEBPACK_IMPORTED_MODULE_0__src_utils_js__["parseSizesInput"](rawSizes).length == 0) {
      return false;
    }

    if (!__WEBPACK_IMPORTED_MODULE_0__src_utils_js__["deepAccess"](bid, 'mediaTypes.video.context')) {
      return false;
    }

    if (!__WEBPACK_IMPORTED_MODULE_0__src_utils_js__["contains"](ENVS, bid.params.env)) {
      return false;
    }
  ...
  buildRequests: function buildRequests(validBidRequests, bidderRequest) {
    return validBidRequests.map(function (bidRequest) {
      ...
      var rawSize = __WEBPACK_IMPORTED_MODULE_0__src_utils_js__["deepAccess"](bidRequest, 'mediaTypes.video.playerSize') || bidRequest.sizes;
      var size = __WEBPACK_IMPORTED_MODULE_0__src_utils_js__["parseSizesInput"](rawSize)[0].split('x'); // Get the page's url
