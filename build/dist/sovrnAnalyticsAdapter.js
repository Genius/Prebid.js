...
var ajax = Object(__WEBPACK_IMPORTED_MODULE_3__src_ajax__["b" /* ajaxBuilder */])(0);
...
var sovrnAnalyticsAdapter = _extends(Object(__WEBPACK_IMPORTED_MODULE_0__src_AnalyticsAdapter__["a" /* default */])({
  url: pbaUrl,
...
sovrnAnalyticsAdapter.enableAnalytics = function (config) {
  ...
  if (config && config.options && (config.options.sovrnId || config.options.affiliateId)) {
    ...
    __WEBPACK_IMPORTED_MODULE_4__src_utils__["logError"]('Need Sovrn Id to log auction results. Please contact a Sovrn representative if you do not know your Sovrn Id.');
    return;
  }
...
function () {
  ...
  function BidWinner(sovrnId, event) {
    ...
    this.body = {};
    this.body.prebidVersion = "Genius_prebid_2.37.0";
    this.body.sovrnId = sovrnId;
    this.body.winningBid = JSON.parse(JSON.stringify(event));
    this.body.url = __WEBPACK_IMPORTED_MODULE_4__src_utils__["getTopWindowLocation"]().href;
  ...
  _createClass(BidWinner, [{
    key: "send",
    value: function send() {
      this.body.ts = __WEBPACK_IMPORTED_MODULE_4__src_utils__["timestamp"]();
...
function () {
  ...
  function AuctionData(sovrnId, auctionId) {
    ...
    this.auction = {};
    this.auction.prebidVersion = "Genius_prebid_2.37.0";
    this.auction.sovrnId = sovrnId;
    this.auction.auctionId = auctionId;
    this.auction.payload = 'auction';
    this.auction.timeouts = {
      buffer: __WEBPACK_IMPORTED_MODULE_5__src_config__["b" /* config */].getConfig('timeoutBuffer'),
      bidder: __WEBPACK_IMPORTED_MODULE_5__src_config__["b" /* config */].getConfig('bidderTimeout')
    };
    this.auction.priceGranularity = __WEBPACK_IMPORTED_MODULE_5__src_config__["b" /* config */].getConfig('priceGranularity');
    this.auction.url = __WEBPACK_IMPORTED_MODULE_4__src_utils__["getTopWindowLocation"]().href;
  ...
  _createClass(AuctionData, [{
    ...
    value: function findBid(event) {
      var bidder = __WEBPACK_IMPORTED_MODULE_6_core_js_library_fn_array_find___default()(this.auction.requests, function (r) {
      ...
      var bid = __WEBPACK_IMPORTED_MODULE_6_core_js_library_fn_array_find___default()(bidder.bids, function (b) {
    ...
    value: function adjustedBid(event) {
      ...
      if (bid) {
        bid.originalValues = Object.keys(event).reduce(function (o, k) {
          if (JSON.stringify(bid[k]) !== JSON.stringify(event[k]) && !__WEBPACK_IMPORTED_MODULE_7_core_js_library_fn_array_includes___default()(_this.dropBidFields, k)) {
            o[k] = bid[k];
            bid[k] = event[k];
          }
    ...
    value: function send() {
      ...
      this.auction.ts = __WEBPACK_IMPORTED_MODULE_4__src_utils__["timestamp"]();
...
function () {
  function LogError(e, sovrnId, data) {
    ...
    this.error.prebidVersion = "Genius_prebid_2.37.0";
    this.error.sovrnId = sovrnId;
    this.error.url = __WEBPACK_IMPORTED_MODULE_4__src_utils__["getTopWindowLocation"]().href;
  ...
  _createClass(LogError, [{
    ...
    value: function send() {
      ...
      this.error.ts = __WEBPACK_IMPORTED_MODULE_4__src_utils__["timestamp"]();
