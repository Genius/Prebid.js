...
var spec = {
  code: BIDDER_CODE,
  supportedMediaTypes: [__WEBPACK_IMPORTED_MODULE_3__src_mediaTypes__["d" /* VIDEO */], __WEBPACK_IMPORTED_MODULE_3__src_mediaTypes__["b" /* BANNER */], __WEBPACK_IMPORTED_MODULE_3__src_mediaTypes__["c" /* NATIVE */]],
  ...
  buildRequests: function buildRequests(validBidRequests, bidderRequest) {
    ...
    for (var i = 0, len = validBidRequests.length; i < len; i++) {
      ...
      queryString = __WEBPACK_IMPORTED_MODULE_1__src_utils__["tryAppendQueryString"](queryString, 'prebid_ver', "2.37.0");

      if (bidderRequest && bidderRequest.refererInfo) {
        queryString = __WEBPACK_IMPORTED_MODULE_1__src_utils__["tryAppendQueryString"](queryString, 'page_url', bidderRequest.refererInfo.referer);
      }
