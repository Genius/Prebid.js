...
var BIDDER_CODE = 'reklamstore';
var ENDPOINT_URL = 'https://ads.rekmob.com/m/prebid';
var CURRENCY = 'USD';
...
var spec = {
  ...
  */
  getUserSyncs: function getUserSyncs(syncOptions, serverResponses) {
    ...
    __WEBPACK_IMPORTED_MODULE_0__src_utils_js__["_each"](serverResponses, function (bidResponse) {
      __WEBPACK_IMPORTED_MODULE_0__src_utils_js__["_each"](bidResponse.body.syncs, function (sync) {
...
function isTablet() {
  ...
  (function (a) {
    if (/ipad|android|android 3.0|xoom|sch-i800|playbook|tablet|kindle/i.test(a)) {
      check = true;
    }
  })(navigator.userAgent || navigator.vendor || window.opera);
