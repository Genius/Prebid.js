...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__src_targeting__ = __webpack_require__(33);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__src_auctionManager__ = __webpack_require__(23);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__src_utils__ = __webpack_require__(0);
...
var defaultUrl = '//pool.tsukiji.iponweb.net/hba';
...
function addAdUnitNameForArray(ar, map) {
  if (__WEBPACK_IMPORTED_MODULE_6__src_utils__["isArray"](ar)) {
...
function addAdUnitName(params, map) {
  ...
  if (__WEBPACK_IMPORTED_MODULE_6__src_utils__["isArray"](params.adUnits)) {
  ...
  if (__WEBPACK_IMPORTED_MODULE_6__src_utils__["isArray"](params.adUnitCodes)) {
...
var yieldoneAnalytics = _extends(Object(__WEBPACK_IMPORTED_MODULE_1__src_AnalyticsAdapter__["a" /* default */])({
  ...
  track: function track(_ref) {
    ...
    if (eventType === __WEBPACK_IMPORTED_MODULE_2__src_constants_json___default.a.EVENTS.BID_REQUESTED) {
      ...
      requestedBidders[reqBidderId] = __WEBPACK_IMPORTED_MODULE_6__src_utils__["deepClone"](args);
    ...
    if (eventType === __WEBPACK_IMPORTED_MODULE_2__src_constants_json___default.a.EVENTS.BID_TIMEOUT && __WEBPACK_IMPORTED_MODULE_6__src_utils__["isArray"](args)) {
      ...
      args.forEach(function (bid) {
        ...
        if ((requestedBidders[reqBidderId] || reqBidders[bid.bidder]) && requestedBids[reqBidId]) {
          if (!reqBidders[bid.bidder]) {
            ...
            eventsStorage[bid.auctionId].push({
              eventType: eventType,
      ...
      if (currentAuctionId) {
        ...
        _eventsStorage[currentAuctionId].push({
          eventType: eventType,
          params: args
        });
      }
    ...
    if (eventType === __WEBPACK_IMPORTED_MODULE_2__src_constants_json___default.a.EVENTS.AUCTION_END || eventType === __WEBPACK_IMPORTED_MODULE_2__src_constants_json___default.a.EVENTS.BID_WON) {
      args.adServerTargeting = __WEBPACK_IMPORTED_MODULE_4__src_targeting__["a" /* targeting */].getAllTargeting(__WEBPACK_IMPORTED_MODULE_5__src_auctionManager__["a" /* auctionManager */].getAdUnitCodes(), __WEBPACK_IMPORTED_MODULE_5__src_auctionManager__["a" /* auctionManager */].getBidsReceived());

      if (yieldoneAnalytics.eventsStorage[args.auctionId]) {
        yieldoneAnalytics.eventsStorage[args.auctionId].forEach(function (it) {
          it.page = {
  ...
  sendStat: function sendStat(events, auctionId) {
    ...
    Object(__WEBPACK_IMPORTED_MODULE_0__src_ajax__["a" /* ajax */])(url, {
