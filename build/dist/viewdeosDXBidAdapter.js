...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4_core_js_library_fn_array_find_index__ = __webpack_require__(80);
...
var URL = '//hb.sync.viewdeos.com/auction/';
var OUTSTREAM_SRC = '//player.sync.viewdeos.com/outstream-unit/2.01/outstream.min.js';
...
var spec = {
  ...
  isBidRequestValid: function isBidRequestValid(bid) {
    return !!__WEBPACK_IMPORTED_MODULE_0__src_utils__["deepAccess"](bid, 'params.aid');
  },
  getUserSyncs: function getUserSyncs(syncOptions, serverResponses) {
    ...
    if (syncOptions.pixelEnabled || syncOptions.iframeEnabled) {
      __WEBPACK_IMPORTED_MODULE_0__src_utils__["isArray"](serverResponses) && serverResponses.forEach(function (response) {
        if (response.body) {
...
function parseRTBResponse(serverResponse, bidderRequest) {
  var isInvalidValidResp = !serverResponse || !__WEBPACK_IMPORTED_MODULE_0__src_utils__["isArray"](serverResponse.bids);
  var bids = [];
...
function bidToTag(bidRequests, bidderRequest) {
  var tag = {
    domain: __WEBPACK_IMPORTED_MODULE_0__src_utils__["deepAccess"](bidderRequest, 'refererInfo.referer')
  };

  if (__WEBPACK_IMPORTED_MODULE_0__src_utils__["deepAccess"](bidderRequest, 'gdprConsent.gdprApplies')) {
    tag.gdpr = 1;
    tag.gdpr_consent = __WEBPACK_IMPORTED_MODULE_0__src_utils__["deepAccess"](bidderRequest, 'gdprConsent.consentString');
  }
...
function prepareRTBRequestParams(_index, bid) {
  ...
  var sizes = bid.sizes ? bid.sizes : mediaType === __WEBPACK_IMPORTED_MODULE_2__src_mediaTypes__["d" /* VIDEO */] ? __WEBPACK_IMPORTED_MODULE_0__src_utils__["deepAccess"](bid, 'mediaTypes.video.playerSize') : __WEBPACK_IMPORTED_MODULE_0__src_utils__["deepAccess"](bid, 'mediaTypes.banner.sizes');
  return _ref2 = {}, _defineProperty(_ref2, 'callbackId' + index, bid.bidId), _defineProperty(_ref2, 'aid' + index, bid.params.aid), _defineProperty(_ref2, 'ad_type' + index, mediaType), _defineProperty(_ref2, 'sizes' + index, __WEBPACK_IMPORTED_MODULE_0__src_utils__["parseSizesInput"](sizes).join()), _ref2;
}
/**
