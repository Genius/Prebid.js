...
var SYNC_ENDPOINT = 'https://sync.meazy.co/sync/iframe';
var ENDPOINT_CONFIG = {
  defaultCurrency: ['USD'],
...
var buildURI = function buildURI(pid) {
  return "https://".concat(PREBID_ENDPOINT, "/pbjs?host=").concat(__WEBPACK_IMPORTED_MODULE_0__src_utils_js__["getOrigin"](), "&api_key=").concat(pid);
};
...
var spec = {
  ...
  buildRequests: function buildRequests(bidRequests, bidderRequest) {
    var payload = {
      ...
      site: {
        domain: __WEBPACK_IMPORTED_MODULE_0__src_utils_js__["getOrigin"]()
      },
      device: {
    ...
    if (bidderRequest.refererInfo) {
      ...
      if (__WEBPACK_IMPORTED_MODULE_0__src_utils_js__["isArray"](bidderRequest.refererInfo) && bidderRequest.refererInfo.stack.length > 0) {
  ...
  interpretResponse: function interpretResponse(serverResponse) {
    ...
    if (!__WEBPACK_IMPORTED_MODULE_0__src_utils_js__["isArray"](serverResponse.body.seatbid) || !serverResponse.body.seatbid[0]) {
      return bids;
    }
  ...
  getUserSyncs: function getUserSyncs(syncOptions, serverResponses) {
    ...
    if (syncOptions.pixelEnabled && serverResponses[0] && __WEBPACK_IMPORTED_MODULE_0__src_utils_js__["deepAccess"](serverResponses[0], 'body.ext.syncUrl')) {
      syncs.push({
        type: 'image',
