...
var ENDPOINT_URL = 'https://t.visx.net/hb';
var TIME_TO_LIVE = 360;
var DEFAULT_CUR = 'EUR';
var ADAPTER_SYNC_URL = 'https://t.visx.net/push_sync';
var LOG_ERROR_MESS = {
...
var spec = {
  ...
  buildRequests: function buildRequests(validBidRequests, bidderRequest) {
    ...
    var currency = __WEBPACK_IMPORTED_MODULE_2__src_config_js__["b" /* config */].getConfig("currency.bidderCurrencyDefault.".concat(BIDDER_CODE)) || __WEBPACK_IMPORTED_MODULE_2__src_config_js__["b" /* config */].getConfig('currency.adServerCurrency') || DEFAULT_CUR;
    var reqId;
    var payloadSchain;
    var payloadUserId;

    if (currencyWhiteList.indexOf(currency) === -1) {
      __WEBPACK_IMPORTED_MODULE_0__src_utils_js__["logError"](LOG_ERROR_MESS.notAllowedCurrency + currency);
      return;
    }
