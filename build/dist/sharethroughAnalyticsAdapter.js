...
var sharethroughAdapter = _extends(Object(__WEBPACK_IMPORTED_MODULE_0__src_AnalyticsAdapter_js__["a" /* default */])({
  emptyUrl: emptyUrl,
  ...
  appendEnvFields: function appendEnvFields(url) {
    url = utils.tryAppendQueryString(url, 'hbVersion', "4.2.0");
