...
var spec = {
  ...
  buildRequests: function buildRequests(validBidRequests, bidderRequest) {
    ...
    var spb = __WEBPACK_IMPORTED_MODULE_1__src_config__["b" /* config */].getConfig('userSync') && __WEBPACK_IMPORTED_MODULE_1__src_config__["b" /* config */].getConfig('userSync').syncsPerBidder ? __WEBPACK_IMPORTED_MODULE_1__src_config__["b" /* config */].getConfig('userSync').syncsPerBidder : 5;
    var payload = {
      start_time: __WEBPACK_IMPORTED_MODULE_0__src_utils__["timestamp"](),
    ...
    for (var x = 0; x < validBidRequests.length; x++) {
      ...
      payload.imps.push({
        ...
        media_types: __WEBPACK_IMPORTED_MODULE_0__src_utils__["deepAccess"](req, 'mediaTypes'),
        has_renderer: req.renderer !== undefined
      });
    }

    var params = validBidRequests[0].params;
    var url = params.endpoint ? params.endpoint : '//market-global.smrtb.com/json/publisher/prebid';
    return {
      method: 'POST',
      url: url,
