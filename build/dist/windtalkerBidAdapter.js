...
function banner(slot) {
  if (slot.mediaType === 'banner' || __WEBPACK_IMPORTED_MODULE_0__src_utils_js__["deepAccess"](slot, 'mediaTypes.banner')) {
...
function videoImpression(slot) {
  if (slot.mediaType === 'video' || __WEBPACK_IMPORTED_MODULE_0__src_utils_js__["deepAccess"](slot, 'mediaTypes.video')) {
    var sizes = __WEBPACK_IMPORTED_MODULE_0__src_utils_js__["deepAccess"](slot, 'mediaTypes.video.playerSize');
    var video = {
      w: sizes[0][0],
      h: sizes[0][1],
      mimes: DEFAULT_MIMES,
...
function parse(rawResponse) {
  try {
    ...
    __WEBPACK_IMPORTED_MODULE_0__src_utils_js__["logError"]('windtalker.parse', 'ERROR', ex);
  }
