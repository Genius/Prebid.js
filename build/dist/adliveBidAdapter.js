...
var spec = {
  ...
  isBidRequestValid: function isBidRequestValid(bid) {
    return !!(bid.params.hashes && __WEBPACK_IMPORTED_MODULE_0__src_utils_js__["isArray"](bid.params.hashes));
  },
    ...
    __WEBPACK_IMPORTED_MODULE_0__src_utils_js__["_each"](validBidRequests, function (bid) {
      requests.push({
        ...
        data: JSON.stringify({
          ...
          hashes: __WEBPACK_IMPORTED_MODULE_0__src_utils_js__["getBidIdParameter"]('hashes', bid.params)
        }),
        bidId: bid.bidId
      });
    });
  ...
  interpretResponse: function interpretResponse(serverResponse, bidRequest) {
    try {
      ...
      __WEBPACK_IMPORTED_MODULE_0__src_utils_js__["_each"](response, function (bidResponse) {
