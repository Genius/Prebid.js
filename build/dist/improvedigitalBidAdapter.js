...
var spec = {
  ...
  code: BIDDER_CODE,
  aliases: ['id'],
  supportedMediaTypes: [__WEBPACK_IMPORTED_MODULE_3__src_mediaTypes__["b" /* BANNER */], __WEBPACK_IMPORTED_MODULE_3__src_mediaTypes__["c" /* NATIVE */], __WEBPACK_IMPORTED_MODULE_3__src_mediaTypes__["d" /* VIDEO */]],
  ...
  buildRequests: function buildRequests(bidRequests, bidderRequest) {
    ...
    var requestParameters = {
      singleRequestMode: __WEBPACK_IMPORTED_MODULE_2__src_config__["b" /* config */].getConfig('improvedigital.singleRequest') === true,
  ...
  interpretResponse: function interpretResponse(serverResponse, bidRequest) {
    ...
    __WEBPACK_IMPORTED_MODULE_0__src_utils__["_each"](serverResponse.body.bid, function (bidObject) {
      ...
      if (bidObject.native) {
        ...
        bid.mediaType = __WEBPACK_IMPORTED_MODULE_3__src_mediaTypes__["c" /* NATIVE */];
        ...
        bid.mediaType = __WEBPACK_IMPORTED_MODULE_3__src_mediaTypes__["b" /* BANNER */];
      } // Common properties
...
function getNormalizedBidRequest(bid) {
  ...
  var singleSizeFilter = __WEBPACK_IMPORTED_MODULE_0__src_utils__["getBidIdParameter"]('size', bid.params) || null;
  ...
  var bidFloorCur = __WEBPACK_IMPORTED_MODULE_0__src_utils__["getBidIdParameter"]('bidFloorCur', bid.params);
  var normalizedBidRequest = {};

  if (isInstreamVideo(bid)) {
    normalizedBidRequest.adTypes = [__WEBPACK_IMPORTED_MODULE_3__src_mediaTypes__["d" /* VIDEO */]];
  }
  ...
  if (__WEBPACK_IMPORTED_MODULE_2__src_config__["b" /* config */].getConfig('improvedigital.usePrebidSizes') === true && !isInstreamVideo(bid) && bid.sizes && bid.sizes.length > 0) {
...
function ImproveDigitalAdServerJSClient(endPoint) {
  ...
  this.createImpressionObject = function (placementObject) {
    ...
    if (placementObject.format && __WEBPACK_IMPORTED_MODULE_0__src_utils__["isArray"](placementObject.format)) {
      var format = placementObject.format.filter(function (sizePair) {
        return sizePair.length === 2 && __WEBPACK_IMPORTED_MODULE_0__src_utils__["isInteger"](sizePair[0]) && __WEBPACK_IMPORTED_MODULE_0__src_utils__["isInteger"](sizePair[1]) && sizePair[0] >= 0 && sizePair[1] >= 0;
