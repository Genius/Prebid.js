...
function onSlotLoaded(_ref6) {
  ...
  var commonFields = {
    ...
    'hb.cur': __WEBPACK_IMPORTED_MODULE_3__src_config__["b" /* config */].getConfig('currency.adServerCurrency'),
...
function getAdUnitByAdId(adId) {
  ...
  __WEBPACK_IMPORTED_MODULE_5__src_utils__["_map"](auctionMap, function (value) {
    ...
    __WEBPACK_IMPORTED_MODULE_5__src_utils__["_map"](auction.adUnitMap, function (value) {
      ...
      __WEBPACK_IMPORTED_MODULE_5__src_utils__["_map"](adUnit.bidMap, function (value) {
        return value;
