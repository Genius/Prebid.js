...
var spec = {
  ...
  buildRequests: function buildRequests(validBidRequests, bidderRequest) {
    ...
    for (var i = 0, len = validBidRequests.length; i < len; i++) {
      ...
      data = __WEBPACK_IMPORTED_MODULE_0__src_utils__["tryAppendQueryString"](data, 'pbver', "2.37.0");
...
function getCurrencyType() {
  if (__WEBPACK_IMPORTED_MODULE_3__src_config__["b" /* config */].getConfig('currency.adServerCurrency') && __WEBPACK_IMPORTED_MODULE_3__src_config__["b" /* config */].getConfig('currency.adServerCurrency').toUpperCase() === 'USD') return 'USD';
  return 'JPY';
}
