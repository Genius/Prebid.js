...
var spec = {
  ...
  _parse: function _parse(rawPayload) {
    try {
      ...
      __WEBPACK_IMPORTED_MODULE_2__src_utils_js__["logError"](LOG_PREFIX, 'Exception: ', ex);
    }
  ...
  isBidRequestValid: function isBidRequestValid(bid) {
    if (!bid || !bid.params) {
      __WEBPACK_IMPORTED_MODULE_2__src_utils_js__["logError"](LOG_PREFIX, 'nil/empty bid object');
      return false;
    }

    if (!__WEBPACK_IMPORTED_MODULE_2__src_utils_js__["isEmpty"](bid.params.publisherId) || !__WEBPACK_IMPORTED_MODULE_2__src_utils_js__["isNumber"](bid.params.publisherId)) {
      __WEBPACK_IMPORTED_MODULE_2__src_utils_js__["logError"](LOG_PREFIX, 'publisherId is mandatory and must be numeric. Ad Unit: ', JSON.stringify(bid));
      return false;
    } // video bid request validation


    if (bid.hasOwnProperty(MEDIA_TYPES) && bid.mediaTypes.hasOwnProperty(__WEBPACK_IMPORTED_MODULE_1__src_mediaTypes_js__["d" /* VIDEO */])) {
      if (!bid.mediaTypes.video.hasOwnProperty(MIMES) || !__WEBPACK_IMPORTED_MODULE_2__src_utils_js__["isArray"](bid.mediaTypes.video.mimes) || bid.mediaTypes.video.mimes.length === 0) {
        __WEBPACK_IMPORTED_MODULE_2__src_utils_js__["logError"](LOG_PREFIX, 'mimes are mandatory for video bid request. Ad Unit: ', JSON.stringify(bid));
        return false;
      }
    }
  ...
  buildRequests: function buildRequests(validBidRequests, bidderRequest) {
    ...
    var clonedBidRequests = __WEBPACK_IMPORTED_MODULE_2__src_utils_js__["deepClone"](validBidRequests);
              ...
              req.imp.forEach(function (impr) {
                if (impr.id === bid.impid) {
                  if (impr.banner) {
                    ...
                    bidResponse.mediaType = __WEBPACK_IMPORTED_MODULE_1__src_mediaTypes_js__["b" /* BANNER */];
                  } else {
  ...
  getUserSyncs: function getUserSyncs(syncOptions, serverResponses) {
    if (syncOptions.iframeEnabled) {
      ...
      __WEBPACK_IMPORTED_MODULE_2__src_utils_js__["logWarn"](LOG_PREFIX + 'Please enable iframe based user sync.');
    }
  },
  ...
  _creatImpression: function _creatImpression(request) {
    ...
    return impression.hasOwnProperty(__WEBPACK_IMPORTED_MODULE_1__src_mediaTypes_js__["b" /* BANNER */]) || impression.hasOwnProperty(__WEBPACK_IMPORTED_MODULE_1__src_mediaTypes_js__["d" /* VIDEO */]) ? impression : undefined;
  },
  ...
  _createBanner: function _createBanner(request) {
    if (__WEBPACK_IMPORTED_MODULE_2__src_utils_js__["deepAccess"](request, 'mediaTypes.banner')) {
      var banner = {};
      var sizes = request.mediaTypes.banner.sizes;

      if (sizes && __WEBPACK_IMPORTED_MODULE_2__src_utils_js__["isArray"](sizes) && sizes.length > 0) {
        var format = [];
        banner.w = sizes[0][0];
        banner.h = sizes[0][1];
  ...
  _createVideo: function _createVideo(request) {
    if (__WEBPACK_IMPORTED_MODULE_2__src_utils_js__["deepAccess"](request, 'mediaTypes.video')) {
      var video = {};
      var sizes = request.mediaTypes.video.playerSize;

      if (sizes && __WEBPACK_IMPORTED_MODULE_2__src_utils_js__["isArray"](sizes) && sizes.length > 1) {
        video.w = sizes[0];
        video.h = sizes[1];
      }
  ...
  _createSite: function _createSite(request, refererInfo) {
    ...
    if (rSite || !request.params.app) {
      ...
      if (refererInfo) {
        ...
        if (__WEBPACK_IMPORTED_MODULE_2__src_utils_js__["isArray"](refererInfo.stack) && refererInfo.stack.length > 0) {
  ...
  _createDevice: function _createDevice(request) {
    ...
    device.dnt = __WEBPACK_IMPORTED_MODULE_2__src_utils_js__["getDNT"]() ? 1 : 0;
