...
var spec = {
  ...
  buildRequests: function buildRequests(validBidRequests, bidderRequest) {
    ...
    var site = {};
    var device = {};
    var refurl = Object(__WEBPACK_IMPORTED_MODULE_3__src_url__["c" /* parse */])(bidderRequest.referrer);
    var requests = [];
    validBidRequests.forEach(function (bidRequest) {
      ...
      } else if (__WEBPACK_IMPORTED_MODULE_0__src_utils__["deepAccess"](bidRequest, 'mediaTypes.native')) {
    ...
    function RtbRequest(device, site, imps) {
      ...
      Object.keys(imps).forEach(function (host) {
        ...
        Object.keys(sourceIds).forEach(function (sourceId) {
          ...
          collection.push({
            url: "".concat(impObj.protocol).concat(host, "/").concat(impObj.path, "/?").concat(impObj.idParam, "=").concat(sourceId),
            body: {
  ...
  interpretResponse: function interpretResponse(serverResponse, bidRequest) {
    ...
    return bids.map(function (rtbBid) {
      ...
      if (!imp) {
        ...
        br.mediaType = __WEBPACK_IMPORTED_MODULE_2__src_mediaTypes__["b" /* BANNER */];
        br.width = rtbBid.w;
        br.height = rtbBid.h;
        br.ad = rtbBid.adm;
      } else if (imp.native) {
        br.mediaType = __WEBPACK_IMPORTED_MODULE_2__src_mediaTypes__["c" /* NATIVE */];
        ...
        br.mediaType = __WEBPACK_IMPORTED_MODULE_2__src_mediaTypes__["d" /* VIDEO */];
        br.width = rtbBid.w;
        br.height = rtbBid.h;
