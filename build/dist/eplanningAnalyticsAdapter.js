...
var eplAnalyticsAdapter = _extends(Object(__WEBPACK_IMPORTED_MODULE_1__src_AnalyticsAdapter_js__["a" /* default */])({
  EPL_HOST: EPL_HOST,
  ...
  track: function track(_ref) {
    ...
    if (eventType === CONSTANTS.EVENTS.AUCTION_END) {
      try {
        ...
        Object(__WEBPACK_IMPORTED_MODULE_0__src_ajax_js__["a" /* ajax */])(eplAnalyticsAdapter.context.host + eplAnalyticsAdapter.context.ci + '?d=' + encodeURIComponent(strjson));
      } catch (err) {}
    }
  }
});
...
eplAnalyticsAdapter.enableAnalytics = function (config) {
  if (!config.options.ci) {
    __WEBPACK_IMPORTED_MODULE_3__src_utils_js__["logError"]('Client ID (ci) option is not defined. Analytics won\'t work');
    return;
  }
