...
var spec = {
  ...
  interpretResponse: function interpretResponse(serverResponse, bidRequest) {
    ...
    for (var i = 0; i < responses.length; i++) {
      ...
      if (VALID_RESPONSES[response.response] && (verifySize(response, __WEBPACK_IMPORTED_MODULE_4__src_utils__["getAdUnitSizes"](bid)) || type === __WEBPACK_IMPORTED_MODULE_2__src_mediaTypes__["d" /* VIDEO */])) {
        bidObject = {
          requestId: bid.bidId,
        ...
        if (!bid.renderer && type === __WEBPACK_IMPORTED_MODULE_2__src_mediaTypes__["d" /* VIDEO */] && __WEBPACK_IMPORTED_MODULE_4__src_utils__["deepAccess"](bid, 'mediaTypes.video.context') === 'outstream') {
          bidObject.renderer = __WEBPACK_IMPORTED_MODULE_3__src_Renderer__["a" /* Renderer */].install({
            id: bid.bidId,
