...
var ENDPOINT = 'https://b.imonomy.com/openrtb/hb/00000';
var USYNCURL = 'https://b.imonomy.com/UserMatching/b/';
var spec = {
  code: BIDDER_CODE,
    ...
    if (response && response.body && response.body.bids) {
      response.body.bids.forEach(function (bid) {
        ...
        if (bid.uuid) {
          ...
          __WEBPACK_IMPORTED_MODULE_0__src_utils_js__["logError"]('No uuid for bid');
        ...
        if (bid.creative) {
          ...
          __WEBPACK_IMPORTED_MODULE_0__src_utils_js__["logError"]('No creative for bid');
        }
