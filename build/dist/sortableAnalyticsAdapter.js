...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__src_ajax__ = __webpack_require__(4);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__src_prebidGlobal__ = __webpack_require__(22);
...
function getSiteKey(options) {
  var sortableConfig = __WEBPACK_IMPORTED_MODULE_6__src_config__["b" /* config */].getConfig('sortable') || {};
...
function getSessionParams() {
  ...
  var urlParams = UTM_PARAMS.map(__WEBPACK_IMPORTED_MODULE_3__src_utils__["getParameterByName"]);
...
function getPrebidVersion() {
  return Object(__WEBPACK_IMPORTED_MODULE_5__src_prebidGlobal__["a" /* getGlobal */])().version;
}
...
function getBiddersFactors() {
  var pb = Object(__WEBPACK_IMPORTED_MODULE_5__src_prebidGlobal__["a" /* getGlobal */])();
  var result = {};
...
function sendEvents(events) {
  ...
  var onSend = function onSend() {
    return __WEBPACK_IMPORTED_MODULE_3__src_utils__["logInfo"]('Sortable Analytics data sent');
  };

  Object(__WEBPACK_IMPORTED_MODULE_4__src_ajax__["a" /* ajax */])(url, onSend, JSON.stringify(mergedEvents), options);
...
function handleAuctionEnd(event) {
  ...
  setTimeout(function () {
    var events = Object.keys(adUnits).map(function (adUnitCode) {
      ...
      var highestBid = bids.length ? bids.reduce(__WEBPACK_IMPORTED_MODULE_3__src_utils__["getOldestHighestCpmBid"]) : null;
...
var sortableAnalyticsAdapter = _extends(Object(__WEBPACK_IMPORTED_MODULE_0__src_AnalyticsAdapter__["a" /* default */])({
  url: DEFAULT_URL,
...
sortableAnalyticsAdapter.enableAnalytics = function (setupConfig) {
  if (this.initConfig(setupConfig)) {
    __WEBPACK_IMPORTED_MODULE_3__src_utils__["logInfo"]('Sortable Analytics adapter enabled');
