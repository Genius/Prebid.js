...
var spec = {
  ...
  isBidRequestValid: function isBidRequestValid(bid) {
    ...
    if (!bid.params) {
      __WEBPACK_IMPORTED_MODULE_0__src_utils_js__["logError"]('bid not valid: params were not provided');
    } else if (!bid.params.publisherid) {
      __WEBPACK_IMPORTED_MODULE_0__src_utils_js__["logError"]('bid not valid: publisherid was not provided');
    } else if (!bid.params.placementCode) {
      __WEBPACK_IMPORTED_MODULE_0__src_utils_js__["logError"]('bid not valid: placementCode was not provided');
    }
