...
var spec = {
  ...
  buildRequests: function buildRequests(bidRequests, bidderRequest) {
    return bidRequests.map(function (bidRequest) {
      ...
      var adUnitSizes = bidRequest.mediaTypes[__WEBPACK_IMPORTED_MODULE_2__src_mediaTypes_js__["b" /* BANNER */]] ? __WEBPACK_IMPORTED_MODULE_0__src_utils_js__["getAdUnitSizes"](bidRequest) : __WEBPACK_IMPORTED_MODULE_0__src_utils_js__["deepAccess"](bidRequest.mediaTypes, 'video.playerSize');
      var sizes = '&sizes=' + adUnitSizes.map(function (size) {
        return "".concat(size[0], "x").concat(size[1]);
      }).join('&sizes=');
      queryString = "".concat(queryString).concat(sizes).concat(bidRequest.mediaTypes[__WEBPACK_IMPORTED_MODULE_2__src_mediaTypes_js__["d" /* VIDEO */]] ? '&media_type=video' : '');
      return {
        method: 'GET',
  ...
  interpretResponse: function interpretResponse() {
    ...
    if (responseObj.vastUrl) {
      ...
      return [{
        ...
        mediaType: __WEBPACK_IMPORTED_MODULE_2__src_mediaTypes_js__["d" /* VIDEO */],
        renderer: renderer
      }];
    }
