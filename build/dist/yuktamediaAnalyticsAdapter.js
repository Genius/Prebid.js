...
var yuktamediaAnalyticsVersion = 'v2.0.0';
var initOptions;
...
var yuktamediaAnalyticsAdapter = _extends(Object(__WEBPACK_IMPORTED_MODULE_1__src_AnalyticsAdapter_js__["a" /* default */])({
  emptyUrl: emptyUrl,
...
function send(data, status) {
  ...
  var yuktamediaAnalyticsRequestUrl = __WEBPACK_IMPORTED_MODULE_4__src_utils_js__["buildUrl"]({
    protocol: 'https',
  ...
  Object(__WEBPACK_IMPORTED_MODULE_0__src_ajax_js__["a" /* ajax */])(yuktamediaAnalyticsRequestUrl, undefined, JSON.stringify(data), {
    method: 'POST',
