...
var spec = {
  ...
  isBidRequestValid: function isBidRequestValid(bid) {
    return getMediaTypeFromBid(bid) === __WEBPACK_IMPORTED_MODULE_2__src_mediaTypes_js__["b" /* BANNER */] && !!bid.params.placeId && !!bid.params.imageUrl && !!bid.params.placement && bid.params.placement === 'inImage';
  },
  ...
  interpretResponse: function interpretResponse(serverResponse) {
    ...
    if (serverBody && __WEBPACK_IMPORTED_MODULE_0__src_utils_js__["isArray"](serverBody)) {
      return __WEBPACK_IMPORTED_MODULE_0__src_utils_js__["_map"](serverBody, function (bid) {
        return buildBid(bid);
      });
    } else {
      return [];
