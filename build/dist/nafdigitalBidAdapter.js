...
var BIDDER_CODE = 'nafdigital';
var URL = 'https://nafdigitalbidder.com/hb';
var spec = {
  code: BIDDER_CODE,
...
function interpretResponse(serverResponse) {
  if (!serverResponse.body || _typeof(serverResponse.body) != 'object') {
    __WEBPACK_IMPORTED_MODULE_0__src_utils_js__["logWarn"]('NAF digital server returned empty/non-json response: ' + JSON.stringify(serverResponse.body));
    return [];
  }
