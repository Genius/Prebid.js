...
var adxcgAnalyticsAdapter = _extends(Object(__WEBPACK_IMPORTED_MODULE_1__src_AnalyticsAdapter_js__["a" /* default */])({
  emptyUrl: emptyUrl,
    ...
    switch (eventType) {
      ...
      case __WEBPACK_IMPORTED_MODULE_3__src_constants_json___default.a.EVENTS.BID_TIMEOUT:
        adxcgAnalyticsAdapter.context.events.bidTimeout = args.map(function (item) {
          return item.bidder;
        }).filter(__WEBPACK_IMPORTED_MODULE_4__src_utils_js__["uniques"]);
        break;
  ...
  return {
    ...
    bids: bidRequests.bids.map(function (bid) {
      return {
        ...
        bidId: bid.bidId,
        start: bid.startTime,
        sizes: __WEBPACK_IMPORTED_MODULE_4__src_utils_js__["parseSizesInput"](bid.sizes).toString(),
        params: bid.params
      };
    })
  };
...
function send(data) {
  var adxcgAnalyticsRequestUrl = __WEBPACK_IMPORTED_MODULE_4__src_utils_js__["buildUrl"]({
    protocol: 'https',
  ...
  Object(__WEBPACK_IMPORTED_MODULE_0__src_ajax_js__["a" /* ajax */])(adxcgAnalyticsRequestUrl, undefined, JSON.stringify(data), {
...
adxcgAnalyticsAdapter.enableAnalytics = function (config) {
  if (!config.options.publisherId) {
    __WEBPACK_IMPORTED_MODULE_4__src_utils_js__["logError"]('PublisherId option is not defined. Analytics won\'t work');
    return;
  }
