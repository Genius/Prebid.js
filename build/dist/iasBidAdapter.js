...
function stringifySlotSizes(sizes) {
  ...
  if (__WEBPACK_IMPORTED_MODULE_0__src_utils_js__["isArray"](sizes)) {
...
function stringifySlot(bidRequest) {
  ...
  var keyValues = __WEBPACK_IMPORTED_MODULE_0__src_utils_js__["getKeys"](slot).map(function (key) {
...
function shallowMerge(dest, src) {
  __WEBPACK_IMPORTED_MODULE_0__src_utils_js__["getKeys"](src).reduce(function (dest, srcKey) {
