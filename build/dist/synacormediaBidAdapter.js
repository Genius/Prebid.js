...
var BID_HOST = '//prebid.technoratimedia.com';
var USER_SYNC_HOST = '//ad-cdn.technoratimedia.com';
...
var spec = {
  ...
  buildRequests: function buildRequests(validBidReqs, bidderRequest) {
    ...
    if (openRtbBidRequest.imp.length && seatId) {
      return {
        method: 'POST',
        url: "".concat(BID_HOST, "/openrtb/bids/").concat(seatId, "?src=Genius_prebid_2.37.0"),
  ...
  getUserSyncs: function getUserSyncs(syncOptions, serverResponses) {
    ...
    if (syncOptions.iframeEnabled) {
      syncs.push({
        type: 'iframe',
        url: "".concat(USER_SYNC_HOST, "/html/usersync.html?src=Genius_prebid_2.37.0")
      });
    } else {
